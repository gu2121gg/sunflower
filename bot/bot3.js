...
(function() {
            ...
            if (buttonText.includes('colet') || buttonText.includes('collect') || buttonText.includes('claim')) {
                ...
                setTimeout(() => {
                    ...
                    if (btnAfterCollect && (txtAfter.includes('cozinh') || txtAfter.includes('cook'))) {
                        ...
                        // Iniciar verificação contínua para coletar
                        checkForCollect(recipeCard, selectedRecipe, cookTime);
                    } else {
    ...
    function checkForCollect(recipeCard, selectedRecipe, cookTime) {
